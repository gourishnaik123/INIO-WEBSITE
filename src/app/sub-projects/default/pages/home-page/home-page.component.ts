...
import { DateandpaxPopupComponent } from "src/app/sub-projects/hotels/shared/components/dateandpax-popup/dateandpax-popup.component";
import { PaxPopupComponent } from "src/app/sub-projects/hotels/shared/components/pax-popup/pax-popup.component";
...
export class HomePageComponent implements OnInit {
  ...
  date:any
  constructor( private reflector: Reflector<any>,public dialog: MatDialog,private api: PropertyServices,private router:Router) {}
  cars = [
    {
...
search() {
  try {
    ...
    let nationality: string | null = this.selectedNationality || '';
